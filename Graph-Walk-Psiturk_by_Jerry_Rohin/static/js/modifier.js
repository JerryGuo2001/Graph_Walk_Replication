...
instruct_1="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>In this experiment, you will observe pairs of objects. Your task is to memorize these pairs. Note that the pairs will repeat, and that the position of the object (left or right) in the pair does not matter. Objects are NOT paired in a meaningful way (for example based on what they are used for).<p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>",
instruct_2="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>A good strategy to remember the pairs is to try and come up with a story or image that connects the two objects. For example, if you saw the following pair of objects: \n </p><img src= '../static/images/GW-Tutorial/object_334.jpg' width='250' height='250' style='margin-right:50px'></img><img src= '../static/images/GW-Tutorial/object_268.jpg' width='250' height='250' style='margin-left:50px'><p style ='font-size: 40px;line-height:1.5'>you may imagine holding the briefcase while wearing the red robe, or you can come up with a story in which you have to pack the robe in the briefcase for a business trip.<br> Let's practice this strategy, which you will use throughout the experiment. For each pair, try to come up with an image or story in your head that connects the two objects. You will have 1 second for each pair,so please work quickly. The story or image does not have to make sense.</p><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>",
instruct_3="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'><img src= '../static/images/GW-Tutorial/object_068.jpg' width='250' height='250' style='margin-right:50px'></img><img src= '../static/images/GW-Tutorial/object_029.jpg' width='250' height='250' style='margin-left:50px'><br><br><p style ='font-size: 40px;line-height:1.5'>Were you able to come up with a story or image connecting these items?<br><br>Once you think of one, press the spacebar to continue.</p>",
...
instruct_5="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'><img src= '../static/images/GW-Tutorial/object_229.jpg' width='250' height='250' style='margin-right:50px'></img><img src= '../static/images/GW-Tutorial/object_250.jpg' width='250' height='250' style='margin-left:50px'><br><br><p style ='font-size: 40px;line-height:1.5'>Were you able to come up with a story or image connecting these items?<br><br>Once you think of one, press the spacebar to continue.</p>",
...
instruct_short_1="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>You may have noticed that the object pairs you studied in the study phase were connected to one another such that one object was often paired with more than just one other object.\nIn this phase, you will be presented with three objects on the screen.\nYour task is to choose which one of the side objects, left or right, you think is closer to the middle object based on how the objects were indirectly associated during the study phase.</p><br /><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>",
instruct_short_2="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>For example, imagine you studied the following flight paths in the earlier phase: </p><br /><img src= '../static/images/Shortest.png' width='750' height='300'></img><p></p><br /><p style= 'font-size:25px;margin-top:50px'>[press the spacebar to continue]</p>",
instruct_short_3="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>In this phase, you will see 3 locations you previously studied:</p><img src= '../static/images/shortestIMG.png' width='500' height='300'></img></p><br /><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>"
instruct_short_4="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>This client will be leaving from the top city (New York City), and wishes to know which out of the two bottom destinations (St. Louis or Detroit) requires fewer layovers.</p><img src= '../static/images/shortestarrow.png' width='600' height='400'<br /><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>"
instruct_short_5="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short1.png' width='1200' height='700'></div>"
instruct_short_6="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short2.png' width='1200' height='700'></div>"
instruct_short_7="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short3.png' width='1200' height='700'></div>"
instruct_short_8="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short4.png' width='1200' height='700'></div>"
instruct_short_9="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short5.png' width='1200' height='700'></div>"
instruct_short_10="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/short6.png' width='1200' height='700'></div>"
//instruct_short_5="<div style='margin-left:250px ;margin-right: 200px ;text-justify: auto'><img src= '../static/images/studyinstruction2.png' width='1200' height='600'></div><br /><p style= 'font-size:25px;margin-top:50px'>[press the spacebar to continue]</p>"
instruct_short_11="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 40px;line-height:1.5'>Press the '1' key to recommend the city on the LEFT, and the '2' key to recommend the city on the RIGHT. If you are unsure of which destination is better, just try your best to make an educated guess.</p><img src= '../static/images/NewYorkCity.png' width='250' height='250'></img><br /><img src= '../static/images/StLouis.png' width='120' height='250' style='margin-right:200px'></img>&nbsp&nbsp&nbsp&nbsp<img src= '../static/images/Detroit.png' width='120' height='250'></img><br /><p style ='font-size: 40px;line-height:1.5;margin-top:50px'>Remember, you want to recommend the destination that requires fewer layovers, and please try to respond as quickly and accurately as possible.</p><br /><p style= 'font-size:25px;margin-top:50px'>[press the spacebar to continue]</p>",
